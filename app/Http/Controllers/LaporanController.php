...
class LaporanController extends Controller
{
    ...
    public function dataBulanan() {
        $data["gol1"] = $data["gol2"] = $data["gol3"] = $data["gol4"] = $data["gol3pppk"] = $data["gol5pppk"] = $data["gol7pppk"] = $data["gol9pppk"] = $data["gol10pppk"] = $data["jumlahGolongan"] = $data["sd"] = $data["smp"] = $data["sma"] = $data["d1"] = $data["d2"] = $data["d3"] = $data["d4"] = $data["s1"] = $data["profesi"] = $data["s2"] = $data["jumlahPendidikan"] = $data["laki"] = $data["perempuan"] = $data["jumlahKelamin"] = $data["eselon2a"] = $data["eselon2b"] = $data["eselon3a"] = $data["eselon3b"] = $data["eselon4a"] = $data["eselon4b"] = $data["nonEselon"] = $jdata["umlahEselon"] = $data["islam"] = $data["kristen"] = $data["katholik"] = $data["hindu"] = $data["buddha"] = $data["jumlahAgama"] = $data["struktural"] = $data["fungsional"] = $data["pelaksana"] = $data["jumlahJenisKepegawaian"] = $data["tenagaTeknis"] = $data["tenagaKesehatan"] = $data["tenagaGuru"] = $data["jumlahKategoriKepegawaian"] = 0;
        ...
        foreach ($query as $key => $value) {
            ...
            switch ($value->nama_gol_ruang) {
                case "I/a": $data["gol1"]++; $data["jumlahGolongan"]++; break;
                case "I/b": $data["gol1"]++; $data["jumlahGolongan"]++; break;
                case "I/c": $data["gol1"]++; $data["jumlahGolongan"]++; break;
                case "I/d": $data["gol1"]++; $data["jumlahGolongan"]++; break;
                case "II/a": $data["gol2"]++; $data["jumlahGolongan"]++; break;
                case "II/b": $data["gol2"]++; $data["jumlahGolongan"]++; break;
                case "II/c": $data["gol2"]++; $data["jumlahGolongan"]++; break;
                case "II/d": $data["gol2"]++; $data["jumlahGolongan"]++; break;
                case "III/a": $data["gol3"]++; $data["jumlahGolongan"]++; break;
                case "III/b": $data["gol3"]++; $data["jumlahGolongan"]++; break;
                case "III/c": $data["gol3"]++; $data["jumlahGolongan"]++; break;
                case "III/d": $data["gol3"]++; $data["jumlahGolongan"]++; break;
                case "IV/a": $data["gol4"]++; $data["jumlahGolongan"]++; break;
                case "IV/b": $data["gol4"]++; $data["jumlahGolongan"]++; break;
                case "IV/c": $data["gol4"]++; $data["jumlahGolongan"]++; break;
                case "IV/d": $data["gol4"]++; $data["jumlahGolongan"]++; break;
